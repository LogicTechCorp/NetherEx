...
public class NetherExPotions
{
    ...
    private static RegistryObject<Potion, Potion> registerPotion(String name, MobEffectInstance mobEffectInstance)
    {
        return POTIONS.register(name, () -> new Potion(name, mobEffectInstance));
    }
}